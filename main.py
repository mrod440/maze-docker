...
Delegates ALL rendering to the View module (CLI).
"""
...
class Engine:
    ...
    def refresh_display(self) -> None:
        ...
        Called from the CLI loop after commands.
        """
    ...
    # ------------------------------------------------------------------
    # Command Dispatch (public — called from the CLI loop)
    # ------------------------------------------------------------------
